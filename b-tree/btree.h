...
// function made by TYLER
// k_index finds the index within our inputted node that 
// our inputted key needs to be inserted at into our node.
//
// NOTE:
// -- this index may be past the limit of keys we can have
// -- this is fine as insert() will take care of our rotation of keys 
//int k_index(btree*& root, int key);

// function made by TYLER
void split_child(btree*& root, int j);
